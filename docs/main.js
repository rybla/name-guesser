...
(() => {
  ...
  var getRandomSubset = (k) => (array) => {
    ...
    for (let i2 = 0; i2 < k; i2++) {
      const randomIndex = Math.floor(Math.random() * (n - i2)) + i2;
      [array[i2], array[randomIndex]] = [array[randomIndex], array[i2]];
  ...
  var initialQuestions = [{
    ...
    prompt: "Waterfalls?",
    answers: ["I hate Waterfalls", "I don't hate Waterfalls"]
  }, {
  ...
  var showTuple2 = /* @__PURE__ */ showTuple(/* @__PURE__ */ showRecord2(/* @__PURE__ */ showRecordFieldsCons({
  ...
  })(showString))(/* @__PURE__ */ showArray(showString))));
  var showTuple1 = /* @__PURE__ */ showTuple2(/* @__PURE__ */ showMaybe(showInt));
  ...
  })(/* @__PURE__ */ showArray(/* @__PURE__ */ showTuple2(showInt))))(showString))(/* @__PURE__ */ showMaybe(showTuple1)))(/* @__PURE__ */ showArray(showTuple1))));
  ...
  var SelectAnswer = /* @__PURE__ */ function() {
    function SelectAnswer2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    SelectAnswer2.create = function(value0) {
      return function(value1) {
        return new SelectAnswer2(value0, value1);
      };
    };
    return SelectAnswer2;
  }();
  var NextQuestion = /* @__PURE__ */ function() {
    function NextQuestion2(value0) {
      this.value0 = value0;
    }
    ;
    NextQuestion2.create = function(value0) {
      return new NextQuestion2(value0);
    };
    return NextQuestion2;
  }();
  var BackQuestion = /* @__PURE__ */ function() {
    function BackQuestion2(value0) {
      this.value0 = value0;
    }
    ;
    BackQuestion2.create = function(value0) {
      return new BackQuestion2(value0);
    };
    return BackQuestion2;
  }();
  var renderQuestion = function(mb_i) {
  ...
  var component = /* @__PURE__ */ function() {
    var render = function(state3) {
      return trace2(show2(state3))(function(v) {
        return div2([classes(["app"])])(fold3([[div2([classes(["title"])])([text5("name-guesser")])], function() {
          ...
          ;
          if (state3.maybe_currentQuestion instanceof Nothing && !$$null(state3.futureQuestions)) {
            return ["active"];
          }
          ;
          return ["inactive"];
    ...
    var initialState = function(_input) {
      return {
        name: "",
        pastQuestions: [],
        maybe_currentQuestion: Nothing.value,
        futureQuestions: []
      };
    };
    var handleAction = function(v) {
      ...
      ;
      if (v instanceof BackQuestion) {
        return discard5(log4("BackQuestion"))(function() {
      ...
      if (v instanceof NextQuestion) {
        return bind5(get2)(function(state3) {
          return discard5(log4("NextQuestion"))(function() {
            if (state3.maybe_currentQuestion instanceof Nothing && $$null(state3.pastQuestions)) {
