...
(() => {
  // output/Translation.App/foreign.js
  var getInput = () => {
              ...
              function go2(bot, top2) {
                switch (top2 - bot) {
                  ...
                  default:
                    ...
                    return apply2(map17(concat2)(go2(bot, pivot)))(go2(pivot, top2));
                }
              }
  ...
  var runUI2 = function(component2) {
    return function(i2) {
      return function(element3) {
        return bind14(liftEffect6(map16(toDocument)(bindFlipped7(document2)(windowImpl))))(function(document3) {
  ...
  var translate = (s1) => {
    ...
    for (var i2 = 0; i2 < s1.length; i2++) {
      s2.push(alphabet[(alphabet.indexOf(s1[i2]) + S) % alphabet.length]);
    }
    s2.push("1");
    while (s2.length < N) {
  ...
  // output/Translation.App/index.js
  ...
  var component = function(dictMonadEffect) {
    ...
    var render = function(v) {
      return div2([])([div2([])([input([id2("input"), onKeyDown(identity7)])]), div2([])([a([href4("https://rybla.github.io/name-guesser/?q=" + v.string)])([text5(v.string)])])]);
    };
    ...
    var handleAction = function(ke) {
      return discard5(function() {
        var $19 = key(ke) === "Enter";
        if ($19) {
          return bind5(liftEffect7(getInput))(function(string) {
            var string$prime = translate(string);
            return discard5(modify_3(function(v) {
              var $20 = {};
              for (var $21 in v) {
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bindFlipped(bindAff)(/* @__PURE__ */ runUI2(/* @__PURE__ */ component(monadEffectAff))({}))(awaitBody));
